    ...
    <section className="home">
      <div className="col-md-2 left-float">
        <div className="pumpfun-log d-flex justify-content-start position-relative align-items-center">
          <Link className="pt-4 pb-3 image-link d-flex gap-2 align-items-center ms-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <div className="home-link d-flex align-items-start nav-text-size">
          <div className="nav flex-column nav-pills gap-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <Link className="nav-link nav-link-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <Link className="nav-link link-hover-text w-100 d-flex align-items-center" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" data-bs-toggle="modal" data-bs-target="#exampleModal">
              <span className="icon-wrapper">
            ...
            <Link className="nav-link link-hover-text" type="button" role="tab" aria-controls="v-pills-disabled" aria-selected="false" disabled data-bs-toggle="modal" data-bs-target="#exampleModal">
              <span className="icon-wrapper" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <Link className="nav-link link-hover-text" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" data-bs-toggle="modal" data-bs-target="#exampleModal">
              <span className="icon-wrapper">
            ...
            <div className="btn-group">
              <Link className="nav-link link-hover-text" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false" data-bs-toggle="dropdown" aria-expanded="false">
                <span className="icon-wrapper">
            ...
            <div className="create-button">
              <button className="btn creat-coin-button text-center py-2" data-bs-toggle="modal" data-bs-target="#exampleModal">create coin</button>
            </div>
          </div>
        </div>
      </div>
